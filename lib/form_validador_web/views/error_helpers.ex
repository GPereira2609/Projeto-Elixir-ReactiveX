defmodule FormValidadorWeb.ErrorHelpers do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FormValidadorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FormValidadorWeb.Gettext, "errors", msg, opts)
    end
  end
end
